...
Upload_path = "received"
os.makedirs(Upload_path, exist_ok=True)
#------------------------------------------
@app.route('/info', methods=['GET','POST']) # Print info 
def info():
    return "<h3>Gamal v1.0.1 | Milad Fadavvi</h3>" 
#------------------------------------------
...
def upload_file():
    ...
    filepath = os.path.join(Upload_path, request.remote_addr + '-' + str(uuid.uuid1()) + '-' + file.filename)
    file.save(filepath)
